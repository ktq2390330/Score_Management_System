...
//	        select * from student where no = ? and deleted=false
	...
	public List<Student> filter(School school,int entYear,String classNum,boolean isAttend)throws Exception{
	    ...
	    if(isAttend){conditionIsAttend=" and is_attend = true";}
	    try{
    ...
    public boolean save(Student student,String schoolCd)throws Exception{
    	...
    	try{
    		...
    		if(old==null){
    			statement=connection.prepareStatement("insert into student(no, name, ent_year, class_num, is_attend, school_cd, deleted) VALUES (?, ?, ?, ?, ?, ?,false)");
